...
contract SimpleBank {
    ...
    function deposit() public payable returns (uint) {
        ...
        uint currentBalance = getBalance(); //get current balance
        balances[msg.sender] = (currentBalance + msg.value); //set new balance

    
        emit LogDepositMade(msg.sender, msg.value); //call event
        return balances[msg.sender]; //return new address
    }
